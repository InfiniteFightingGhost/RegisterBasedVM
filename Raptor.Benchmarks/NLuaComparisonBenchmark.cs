...
[MemoryDiagnoser]
public class NLuaComparisonBenchmark
{
    private VirtualMachine _raptorVm = null!;
    private ScriptEngine _raptorEngine = null!;
    private Lua _nluaFFI = null!;
    private Lua _nluaFib = null!;
    private Lua _nluaArray = null!;
    private Lua _nluaEcs = null!;
    ...
    public void Setup()
    {
        ...
        // 2. Setup NLua Engines
        _nluaFFI = new Lua();
        _nluaFFI.RegisterFunction("hostAdd", typeof(NLuaComparisonBenchmark).GetMethod(nameof(HostAdd)));
        _nluaFFI.DoString($@"
            function runFFI()
    ...
    [Benchmark]
    public object[] NLua_FFI_Overhead() => _nluaFFI.GetFunction("runFFI").Call();
    ...
    [Benchmark]
    public object[] NLua_Fibonacci() => _nluaFib.GetFunction("runFib").Call();
    ...
    [Benchmark]
    public object[] NLua_ArrayAccess() => _nluaArray.GetFunction("runArray").Call();
    ...
    [Benchmark]
    public object[] NLua_EcsUpdate() => _nluaEcs.GetFunction("runECS").Call();
}
